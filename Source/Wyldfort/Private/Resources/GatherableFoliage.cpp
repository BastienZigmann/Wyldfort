...
UGatherableFoliage::UGatherableFoliage()
{
}

void UGatherableFoliage::OnRegister()
{
    Super::OnRegister();
...
#if WITH_EDITOR
void UGatherableFoliage::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
